  ...
  return (
    <section id="hero-section" className="relative overflow-hidden bg-gradient-to-b from-pink-50 via-white to-pink-50/30 px-4 pt-10 pb-12 sm:pt-16 sm:pb-20 border-b border-pink-100/50">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        {/* Prova Social Discreta no Hero */}
        <p className="mt-5 mb-2 text-center text-xs sm:text-sm font-medium text-slate-500">
          ⭐⭐⭐⭐⭐ Centenas de mães já aprovaram
        </p>
        ...
        <p className="mt-5 inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-pink-400">
          <span aria-hidden="true">👇</span> Arraste para baixo
        </p>

        <div className="mt-1 flex justify-center text-pink-400">
